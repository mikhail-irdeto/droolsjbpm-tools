...
public class RuleFlowProcessWrapper extends ProcessWrapper {
    ...
    protected void internalAddElement(ElementWrapper element) {
        ...
        // overwrite the potentially non-unique value generated by the jbpm-flow
        ((org.jbpm.workflow.core.Node) node).setMetaData("UniqueId", "_" + UUID.randomUUID().toString());
    ...
    public boolean canAddElement(ElementWrapper element) {
        if (element instanceof StartNodeWrapper && getRuleFlowProcess().getStart(null) != null) {
            return false;
        }
        return true;
    }
